...
export default function Calculator (): ReactElement {
  ...
  function getSearchParamOrDefault (parameterName: string, defaultValue: number): number {
    ...
    <div className="flex flex-col w-1/2 mx-auto">
      ...
      <form onChange={() => { displayCookTime() }} className="flex flex-1 flex-col mt-8 space-y-8">
        ...
        <FormCluster title="Mass parameters">
          <FormNumericInputBox label="Mass of food (in g)" id="mass-food" max={50000} min={0} step={1} defaultValue={getSearchParamOrDefault('mass', 107)}></FormNumericInputBox>
        ...
        <FormCluster title="Temperature parameters">
          ...
          <FormNumericInputBox label="Target temperature (in C)" id="temperature-target" max={200} min={-273} step={1} defaultValue={getSearchParamOrDefault('temperature_target', 80)}></FormNumericInputBox>
        </FormCluster>
        <FormCluster title="Physics parameters">
          <FormNumericInputBox label="Specific Heat Capacity of food (in J/gK)" id="shc-food" max={4.5} min={1.0} step={0.05} defaultValue={getSearchParamOrDefault('shc_food', 2.7)}></FormNumericInputBox>
